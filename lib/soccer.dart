...
class _BluetoothAppSoccerState extends State<BluetoothAppSoccer> {
                    ...
                    child: Center(
                      child: Row(
                        ...
                        children: [
                          ElevatedButton(
                            child: Text("STOP"),
                            onPressed: _connected ? _sendMatiToBlue : null,
                            style: ButtonStyle(
                                backgroundColor:
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: InkWell(
                                        onTap:
                                            _connected ? _sendMajuToBlue : null,
                                        child: ClipRRect(
                                          borderRadius:
                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      child: InkWell(
                                        onTap:
                                            _connected ? _sendKiriToBlue : null,
                                        child: ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(20.0),
                                          child: Image.asset(
  ...
  // for turning the Bluetooth device onr
